...
/home/nx/anaconda3/envs/distdgl/bin/python xgnn/utils/launch.py   \
		--workspace /home/nx/ningxin/DistGNN/xgnn  \
		--num_trainers 1   \
		--num_samplers 0   \
		--num_servers 1   \
		--part_config /home/data/xgnn/ogb-products/random/4part_data/ogbn-products.json   \
		--ip_config examples/ip_config.txt  \
		"docker exec --env PYTHONPATH=/home/xgnn --env NCCL_IB_DISABLE=1 --env NCCL_DEBUG=INFO -w /home/xgnn xgnn /opt/conda/bin/python examples/xgnn/graphsage/main.py \
...
# # "cd /home/nx/ningxin/nfs/XGNN/XGNN; \
...
# # /home/nx/anaconda3/envs/distdgl/bin/python  /home/nx/ningxin/nfs/XGNN/XGNN/main.py \
...
# # /home/nx/ningxin/nfs/XGNN/XGNN/main.py --graph_name ogbn-products --ip_config ip_config.txt  \
# # --part_config /home/nx/ningxin/.data/p3/2part_data/ogbn-products.json)" &

# ## 服务端和客户端位于同一个docker
# # 运行容器
# # ssh -o StrictHostKeyChecking=no -p 22 $1 \
# # "sudo docker run --gpus all -v /home/nx/ningxin/nfs/XGNN/XGNN/:/home/XGNN -v /home/nx/ningxin/.data/p3/2part_data/:/home/2part_data \
# # --rm -dit --shm-size="5g" --network=host --name xgnn dgl /bin/bash" \

# # 服务端
# ssh -o StrictHostKeyChecking=no -p 22 $1 \
# "docker exec \
# --env DGL_ROLE=server --env DGL_NUM_SAMPLER=0 --env OMP_NUM_THREADS=1 --env DGL_NUM_CLIENT=2 \
# --env DGL_CONF_PATH=/home/2part_data/ogbn-products.json --env DGL_IP_CONFIG=/home/XGNN/ip_config.txt \
# --env DGL_NUM_SERVER=1 --env DGL_GRAPH_FORMAT=csc  --env DGL_SERVER_ID=$2 \
# xgnn /opt/conda/bin/python /home/XGNN/main.py --graph_name ogbn-products --ip_config /home/XGNN/ip_config.txt --part_config /home/2part_data/ogbn-products.json" &
...
# xgnn /opt/conda/bin/python -m torch.distributed.launch --nproc_per_node=1 --nnodes=2 --node_rank=$2 --master_addr=11.11.11.18 --master_port=1234 \
# /home/XGNN/main.py --graph_name ogbn-products --ip_config /home/XGNN/ip_config.txt  --part_config /home/2part_data/ogbn-products.json" &

# # 服务端和客户端位于不同容器
# # 服务端
# # ssh -o StrictHostKeyChecking=no -p 22 $1 \
# # "docker run --gpus all -v /home/nx/ningxin/nfs/XGNN/XGNN/:/home/XGNN -v /home/nx/ningxin/.data/p3/2part_data/:/home/2part_data --rm -dit --network=host \
# # --env DGL_ROLE=server --env DGL_NUM_SAMPLER=0 --env OMP_NUM_THREADS=1 --env DGL_NUM_CLIENT=2 \
# # --env DGL_CONF_PATH=/home/2part_data/ogbn-products.json --env DGL_IP_CONFIG=/home/XGNN/ip_config.txt \
# # --env DGL_NUM_SERVER=1 --env DGL_GRAPH_FORMAT=csc  --env DGL_SERVER_ID=$2 \
# # dgl /opt/conda/bin/python /home/XGNN/main.py --graph_name ogbn-products --ip_config /home/XGNN/ip_config.txt --part_config /home/2part_data/ogbn-products.json" &

# # 客户端:训练器
# # ssh -o StrictHostKeyChecking=no -p 22 $1 \
# # "docker run --gpus all -v /home/nx/ningxin/nfs/XGNN/XGNN/:/home/XGNN -v /home/nx/ningxin/.data/p3/2part_data/:/home/2part_data --rm --network=host \
# # --env DGL_DIST_MODE=distributed --env DGL_ROLE=client --env DGL_NUM_SAMPLER=0 --env DGL_NUM_CLIENT=2 \
# # --env DGL_CONF_PATH=/home/2part_data/ogbn-products.json --env DGL_IP_CONFIG=/home/XGNN/ip_config.txt \
# # --env DGL_NUM_SERVER=1 --env DGL_GRAPH_FORMAT=csc --env OMP_NUM_THREADS=28 \
