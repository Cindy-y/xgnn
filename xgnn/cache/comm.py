...
class HostRankTable:
    def __init__(self, hosts, rank_per_host):
        ...
        self.host2ranks = dict()                     ## 字典，以host为键，对应的进程id列表为值
        self.rank2host = []                          ## 列表，indice处的值记录对应id==indice的进程所属设备号
        cnt = 0
...
class NcclComm:
    ...
    def __init__(self, rank, ws, id, hosts=None, rank_per_host=None):
        self.comm = propeller.NcclComm(rank, ws, id)
...
def getNcclId():
    return propeller.create_nccl_id()
